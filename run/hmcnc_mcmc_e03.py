"""Bare-bones RWM for the e=0.3 injection (controlled counterpart to the e=0 run)."""
...
INJ = "/scratch/e1498138/eGB-multi/sangria_hmcnc_10x_e0_3.h5"
OUT = "/scratch/e1498138/eGB-multi/hmcnc_mcmc_e03.npz"
N_STEPS = 5000
SIGMA = jnp.array([2e-3, 0.004, 0.004])
...
BOUNDS = np.array([[0.0, 0.60], [0.50, 0.60], [0.24, 0.30]])
XYZ, CH = ("X", "Y", "Z"), ("A", "E")
