"""Bare-bones random-walk MCMC for the ZTF J1539+5027 e=0.1 injection.
...
INJ = "/scratch/e1498138/eGB-multi/sangria_j1539_10x_e01.h5"
OUT = "/scratch/e1498138/eGB-multi/j1539_mcmc_e01.npz"
N_STEPS = 15000
SIGMA = jnp.array([5e-4, MASS_SIGMA, MASS_SIGMA])
BOUNDS = np.array([[0.0, 0.30], *MASS_BOUNDS])
XYZ, CH = ("X", "Y", "Z"), ("A", "E")
