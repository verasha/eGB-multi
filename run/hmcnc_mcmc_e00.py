"""Bare-bones random-walk MCMC for the HM Cnc injection."""
...
INJ = "/scratch/e1498138/eGB-multi/sangria_hmcnc_10x.h5"
OUT = "/scratch/e1498138/eGB-multi/hmcnc_mcmc_min.npz"
N_STEPS = 5000
SIGMA = jnp.array([5e-4, 0.004, 0.004])
BOUNDS = np.array([[0.0, 0.01], [0.50, 0.60], [0.24, 0.30]])
XYZ, CH = ("X", "Y", "Z"), ("A", "E")
